...
public class PackageQuery {
    TreeMap<string,Package>? _package_map;
    ...
    public TreeMap<string,Package> current_package_map { get { return _package_map; } }

    public PackageQuery.package_map(TreeMap<string,Package> package_map , PackageQueryType query_type) {
